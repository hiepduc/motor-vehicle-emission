...
# Total emission in GMR
tot_no2all.sum()
tot_pm25all.sum()

nc_edms2013petrol = xarray.open_dataset(petrolexhwday)
nc_edms2013diesel = xarray.open_dataset(dieselexhwday)
nc_edms2013diesel["NO2"][12,:,:].plot()
plt.show()

#from pyproj import Proj, transform

# Define the UTM projection (example for UTM zone 56S)
#utm_proj = Proj(proj='utm', zone='56', south='True', ellps='WGS84')
#latlon_proj = Proj(proj='latlong', datum='WGS84')

# Apply the conversion to the coordinates
nc_edms2013diesel["Easting"] = nc_edms2013diesel["Easting"]*1000
nc_edms2013diesel["Northing"] = nc_edms2013diesel["Northing"]*1000
nc_edms2013petrol["Easting"] = nc_edms2013petrol["Easting"]*1000
nc_edms2013petrol["Northing"] = nc_edms2013petrol["Northing"]*1000
nc_edms2013diesel = nc_edms2013diesel.rename({"Hour":"Time"})
nc_edms2013petrol = nc_edms2013petrol.rename({"Hour":"Time"})
# Use rio to reporject. First change the Northing and Easting to standard rio names y, x
import rioxarray
nc_edms2013diesel = nc_edms2013diesel.rename({'Northing': 'y', 'Easting': 'x'})
nc_edms2013diesel = nc_edms2013diesel.rio.write_crs("EPSG:32756")
nc_edms2013petrol = nc_edms2013petrol.rename({'Northing': 'y', 'Easting': 'x'})
nc_edms2013petrol = nc_edms2013petrol.rio.write_crs("EPSG:32756")

# Reproject to lat/lon (EPSG:4326)
nc_edms2013diesel_latlon = nc_edms2013diesel.rio.reproject("EPSG:4326")
nc_edms2013petrol_latlon = nc_edms2013petrol.rio.reproject("EPSG:4326")

# Now ds_latlon has lat/lon coordinates
print(nc_edms2013diesel_latlon)
print(nc_edms2013petrol_latlon)

nc_edms2013diesel_latlon.to_netcdf("edms2013diesel.nc")
nc_edms2013petrol_latlon.to_netcdf("edms2013petrol.nc")
nc_edms2013diesel_latlon.NO2.isel(Time=13).where(nc_edms2013diesel_latlon.NO2.isel(Time=13) != 0.).plot()
nc_edms2013petrol_latlon.NO2.isel(Time=13).where(nc_edms2013petrol_latlon.NO2.isel(Time=13) != 0.).plot()
